...
int main(int argc, char* argv[])
{
	...
	Material mickeyMaterial( Colour(0.8,0.8,0.8), Colour(0.8, 0.8, 0.8),
		Colour(0.8,0.8,0.8), 10.0 );
	...
	// SceneDagNode* bunny = raytracer.addObject( new Mesh("bunny.obj"), &gold );
	SceneDagNode* mickey = raytracer.addObject( new Mesh("mickey.obj"), &mickeyMaterial);
	...
	// double bunnyFactor[3] = { 10, 10, 10 };
	// raytracer.translate(bunny, Vector3D(-2, 0, -3));
	// raytracer.scale(bunny, Point3D(0, 0, 0), bunnyFactor);

	double mickeyFactor[3] = { 0.005, 0.005, 0.005 };
	raytracer.translate(mickey, Vector3D(-2, 0, -3));
	raytracer.scale(mickey, Point3D(0, 0, 0), mickeyFactor);
